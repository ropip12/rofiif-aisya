...
class RiskMonitoringController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('risk-management.monitoring.index', [
            'risks' => $risks,
            'summary' => $summary,
    ...
    public function update(Request $request, Risk $risiko): RedirectResponse
    {
        ...
        $risiko->update([
            ...
            'monitoring' => $validated['monitoring'] ?? $risiko->monitoring,
        ]);

        return redirect()->route('risiko.monitoring')->with('success', 'Status monitoring risiko berhasil diperbarui.');
    }
}
