...
@section('title', 'Edit Penggunaan Aset')
@section('page_title', 'Edit Penggunaan Aset')

@section('content')
    <div class="page-card">
        <h1>Edit Data Penggunaan</h1>
        <div class="subtitle">Perbarui data penggunaan aset.</div>

        <form method="POST" action="{{ route('aset.penggunaan.update', ['asset_usage' => $item->id]) }}" style="display:grid; gap:16px; max-width:800px;">
            @csrf
            @method('PUT')
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location', $item->location) }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
                ...
                <div>
                    ...
                    <input type="text" id="responsible_person" name="responsible_person" value="{{ old('responsible_person', $item->responsible_person) }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="text" id="usage_status" name="usage_status" value="{{ old('usage_status', $item->usage_status) }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
                ...
                <div>
                    ...
                    <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $item->start_date?->format('Y-m-d')) }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
            ...
            <div>
                ...
                <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $item->end_date?->format('Y-m-d')) }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
            ...
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
                ...
                <a href="{{ route('aset.penggunaan.index') }}" style="background:#e2e8f0; color:#0f172a; padding:11px 16px; border-radius:8px; font-weight:700;">Kembali</a>
            </div>
        </form>
    </div>
@endsection
