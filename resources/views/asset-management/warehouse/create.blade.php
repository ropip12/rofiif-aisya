...
@section('title', 'Tambah Gudang Aset')
@section('page_title', 'Tambah Gudang Aset')

@section('content')
    <div class="page-card">
        <h1>Tambah Data Gudang</h1>
        <div class="subtitle">Catat lokasi dan status penyimpanan aset.</div>

        <form method="POST" action="{{ route('aset.gudang.store') }}" style="display:grid; gap:16px; max-width:800px;">
            @csrf
            <div>
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="text" id="warehouse_location" name="warehouse_location" value="{{ old('warehouse_location') }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
                ...
                <div>
                    ...
                    <input type="text" id="storage_status" name="storage_status" value="{{ old('storage_status') }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                <div>
                    ...
                    <input type="date" id="entry_date" name="entry_date" value="{{ old('entry_date') }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
                ...
                <div>
                    ...
                    <input type="date" id="exit_date" name="exit_date" value="{{ old('exit_date') }}" style="width:100%; padding:10px 12px; border:1px solid #dfe7f4; border-radius:8px;">
            ...
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
                ...
                <a href="{{ route('aset.gudang.index') }}" style="background:#e2e8f0; color:#0f172a; padding:11px 16px; border-radius:8px; font-weight:700;">Batal</a>
            </div>
        </form>
    </div>
@endsection
